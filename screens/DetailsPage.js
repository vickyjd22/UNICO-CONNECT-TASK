            ...
            return (
              <View>
                <Avatar
                  ...
                  containerStyle={{ backgroundColor: "black", margin: 15 }}
                  size="large"
                  source={{
                    uri:
                      rowData.imageUrl,
                  }}/>
                <Text style={{ textAlign: "center", fontSize: 12, color: "grey", fontWeight: 'bold', width: 120 }}>
                  {rowData.title}
                </Text>
              </View>
            );
              ...
              <View>
                <Card
                  ...
                  <View style={{ backgroundColor: "white", height: 120, }}>
                    <View style={{ flexDirection: "row", backgroundColor: "red", height: 90, width: 90, borderRadius: 20, margin: 15 }}>
                      <Text style={{ color: "white", padding: 30, fontWeight: 'bold', fontSize: 20, marginLeft: 4 }}>01</Text>
                      <View style={{ flexDirection: 'column' }}>
                        <Text style={{ textAlign: "left", fontSize: 17, marginLeft: 15, color: "black", fontWeight: 'bold', width: 200 }}>
                          Pay in Full Or Pay Monthly
                        </Text>
                        <Text style={{ textAlign: "left", fontSize: 12, marginLeft: 15, color: "grey", fontWeight: 'bold' }}>
